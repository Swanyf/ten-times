...
import com.swan.article.service.ChannelService;
...
public class ChannelController {
	...
	public ResponseEntity findAll(){
		return new ResponseEntity(true,StatusCode.SUCCESS.getCode(),"查询成功",channelService.findAll());
	}
	...
	public ResponseEntity findById(@PathVariable String id){
		return new ResponseEntity(true,StatusCode.SUCCESS.getCode(),"查询成功",channelService.findById(id));
	}
    ...
    public ResponseEntity findSearch( @RequestBody Map searchMap){
        return new ResponseEntity(true,StatusCode.SUCCESS.getCode(),"查询成功",channelService.findSearch(searchMap));
    }
