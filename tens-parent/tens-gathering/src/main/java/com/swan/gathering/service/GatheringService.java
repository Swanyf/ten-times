package com.swan.gathering.service;
...
import com.swan.gathering.mapper.GatheringMapper;
...
public class GatheringService {
    ...
    public Page<Gathering> findSearch(Map whereMap, int page, int size) {
        ...
        return gatheringMapper.findAll(specification, pageRequest);
    }
     ...
     * @return
     */
    @Cacheable(value = "gathering", key = "#id")   // value 缓存名称，key能获取参数值
    public Gathering findById(String id) {
        return gatheringMapper.findById(id).get();
    }
