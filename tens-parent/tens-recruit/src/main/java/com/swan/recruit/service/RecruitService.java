package com.swan.recruit.service;
...
import com.swan.recruit.mapper.RecruitMapper;
...
public class RecruitService {
	...
	public Page<Recruit> findSearch(Map whereMap, int page, int size) {
		...
		return recruitMapper.findAll(specification, pageRequest);
	}
	...
	public List<Recruit> findSearch(Map whereMap) {
		Specification<Recruit> specification = createSpecification(whereMap);
		return recruitMapper.findAll(specification);
	}
	...
	public Recruit findById(String id) {
		return recruitMapper.findById(id).get();
	}
	...
	public List<Recruit> searchRecommend() {
        return recruitMapper.findTop12ByStateOrderByCreatetimeDesc("2");
	}

    public List<Recruit> searchNewlist() {
        return recruitMapper.findTop4ByStateNotOrderByCreatetimeDesc("0");
    }
}
